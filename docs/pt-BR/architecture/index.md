...
graph TB
    ...
    subgraph "Plano de Dados (por no)"
...
3. Renderiza configuracao especifica do engine (Unbound conf, Corefile ou recursor.conf)
...
Um DaemonSet executando em cada no que:
